    ...
    sendSMS(phoneNumber, countryCode, message, userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield axios_1.default.get(this.baseUrl, { params, headers: { Accept: 'application/json' } });
                ...
                throw new ApiErrors_1.default(http_status_codes_1.StatusCodes.EXPECTATION_FAILED, `SMS failed: ${error.message}`);
            }
        });
    }
}
