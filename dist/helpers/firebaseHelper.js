...
const firebaseSDK_json_1 = __importDefault(
  require("../../src/firebaseSDK.json"),
);
...
//multiple user
const sendPushNotifications = (values) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const res = yield firebase_admin_1.default
      .messaging()
      .sendEachForMulticast(values);
