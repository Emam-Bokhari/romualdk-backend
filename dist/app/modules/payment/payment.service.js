...
const createCheckoutSession = (input) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const readBooks = () => {
      ...
      console.log(
        "dashboard overview page, customer managements,order management,product management,chat,admin management,settings",
      );
    };
...
const handleWebhook = (rawBody, sig) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    let event;
    try {
    ...
    if (event.type === "checkout.session.completed") {
      ...
      if (
        booking &&
        booking.status === booking_interface_1.BOOKING_STATUS.PENDING
      ) {
        ...
        const paymentIntent = yield stripe_1.default.paymentIntents.retrieve(
          paymentIntentId,
        ...
        const chargeId =
          typeof paymentIntent.latest_charge === "string"
            ...
            : (_b = paymentIntent.latest_charge) === null || _b === void 0
              ? void 0
              : _b.id;
        if (!chargeId) {
...
const payoutToHost = (bookingId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (
      !transaction ||
      transaction.status !== transaction_model_1.TransactionStatus.SUCCEEDED
    )
      return;
    const isEligibleForPayout =
      booking.checkOut === true ||
      (booking.status === booking_interface_1.BOOKING_STATUS.CANCELLED &&
        ((_a = transaction.refundAmount) !== null && _a !== void 0 ? _a : 0) >
          0);
    if (!isEligibleForPayout) return;
    const host = yield user_model_1.User.findById(booking.hostId);
    if (
      !(host === null || host === void 0 ? void 0 : host.connectedAccountId) ||
      !host.payoutsEnabled
    ) {
      throw new Error("Host payout not enabled");
    }
    const refundedAmount =
      (_b = transaction.refundAmount) !== null && _b !== void 0 ? _b : 0; // USD
