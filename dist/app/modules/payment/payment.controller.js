...
const initiatePayment = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield payment_service_1.PaymentService.createCheckoutSession(payload);
...
const stripeWebhook = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield payment_service_1.PaymentService.handleWebhook(req.body, sig);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
...
const payoutToHostController = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { bookingId } = req.params;
    const result = yield payment_service_1.PaymentService.payoutToHost(bookingId);
    (0, sendResponse_1.default)(res, {
        statusCode: 200,
        success: true,
