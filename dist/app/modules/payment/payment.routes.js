...
router.post(
  "/create",
  (0, validateRequest_1.default)(payment_validation_1.initiatePaymentSchema),
  payment_controller_1.PaymentController.initiatePayment,
);
...
router.post(
  ...
  payment_controller_1.PaymentController.payoutToHostController,
);
