...
const transaction_model_1 = __importStar(
...
const getAllTransactions = (query) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const baseQuery = transaction_model_1.default.find().populate({
      path: "bookingId",
      populate: { path: "carId userId hostId" },
    });
...
const updateTransaction = (id, payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!mongoose_1.Types.ObjectId.isValid(id))
      throw new Error("Invalid Transaction ID");
    const transaction = yield transaction_model_1.default.findByIdAndUpdate(
      id,
      payload,
      {
        new: true,
...
const getPlatformMonthlyRevenue = (year) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const targetYear =
