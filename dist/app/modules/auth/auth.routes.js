...
router.post(
  "/resend-otp",
  (0, validateRequest_1.default)(
    auth_validation_1.AuthValidation.createResendOTPSchema,
...
router.post(
  "/verify-phone",
  (0, validateRequest_1.default)(
    auth_validation_1.AuthValidation.createVerifyPhoneZodSchema,
  ),
...
router.delete(
  "/delete-account",
  (0, auth_1.default)(user_1.USER_ROLES.ADMIN),
