...
// verify Phone OTP
const verifyPhone = (0, catchAsync_1.default)((req, res) =>
...
const forgetPassword = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield auth_service_1.AuthService.forgetPasswordToDB(
      phone,
      countryCode,
    );
    (0, sendResponse_1.default)(res, {
...
// resend OTP (Phone)
const resendPhoneOTP = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { phone, countryCode } = req.body; // ✅ Added countryCode
    const result = yield auth_service_1.AuthService.resendPhoneOTPToDB(
      phone,
      countryCode,
    );
    (0, sendResponse_1.default)(res, {
