...
const forgetPasswordToDB = (phone, countryCode) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const verifyPhoneToDB = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    // OTP validation
    const isValid = yield sendOtpWithVerify_1.twilioService.verifyOTP(
      phone,
      code,
      countryCode,
    );
...
const resendPhoneOTPToDB = (phone, countryCode) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    // ✅ Pass countryCode to Twilio
    const result = yield sendOtpWithVerify_1.twilioService.sendOTPWithVerify(
      phone,
      countryCode,
    );
    return result;
