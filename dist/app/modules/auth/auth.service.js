...
const forgetPasswordToDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (phone) {
        ...
        try {
            yield afrikSms_service_1.afrikSmsService.sendSMS(phone, countryCode, smsMessage);
        }
        catch (error) {
            throw new ApiErrors_1.default(http_status_codes_1.StatusCodes.EXPECTATION_FAILED, "Failed to send reset code to phone.");
        }
        const authentication = {
            oneTimeCode: otp,
    ...
    if (email) {
        ...
        const value = { otp, email: userByEmail.email };
        const forgetPasswordTemplate = emailTemplate_1.emailTemplate.resetPassword(value);
        // Email helper call
...
const verifyPhoneToDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const dbOtp = (_a = isExistUser.authentication) === null || _a === void 0 ? void 0 : _a.oneTimeCode;
    const expiry = (_b = isExistUser.authentication) === null || _b === void 0 ? void 0 : _b.expireAt;
    const isValid = dbOtp !== null &&
        dbOtp === Number(code) &&
...
const resetPasswordToDB = (token, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield user_model_1.User.findOneAndUpdate({ _id: isExistToken.user }, {
        $set: {
            password: hashPassword,
            "authentication.isResetPassword": false,
            "authentication.oneTimeCode": null,
...
const changePasswordToDB = (user, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield user_model_1.User.findOneAndUpdate({ _id: user.id }, updateData, {
        new: true,
    });
    return result;
});
...
const resendPhoneOTPToDB = (phone, countryCode) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        throw new ApiErrors_1.default(http_status_codes_1.StatusCodes.EXPECTATION_FAILED, `Failed to resend OTP: ${error.message}`);
    }
    const authentication = {
        oneTimeCode: otp,
        expireAt: new Date(Date.now() + 5 * 60 * 1000), // 5 minutes
    ...
    const result = yield user_model_1.User.findOneAndUpdate({ phone, countryCode }, { $set: { authentication } }, { new: true });
    return {
        phone: result === null || result === void 0 ? void 0 : result.phone,
        countryCode: result === null || result === void 0 ? void 0 : result.countryCode,
