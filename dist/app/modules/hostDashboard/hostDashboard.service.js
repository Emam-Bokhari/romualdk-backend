...
const getHostDashboardData = (hostId, year) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    ...
    const [profile, totalEarnings, thisMonthEarnings, totalBookings, totalVehicles, activeVehicles, monthlyRevenue, recentPayouts, upcomingPayouts,] = yield Promise.all([
    ...
    const revenueStatistics = months.map((month, index) => {
        ...
        return { month, earnings: (found === null || found === void 0 ? void 0 : found.earnings) || 0 };
    });
    console.log(profile);
    return {
        profile: {
            name: profile
                ...
                : "Unknown",
            location: (profile === null || profile === void 0 ? void 0 : profile.city) && (profile === null || profile === void 0 ? void 0 : profile.country)
                ? `${profile.city}, ${profile.country}`
                : "Unknown",
            profileImage: (profile === null || profile === void 0 ? void 0 : profile.profileImage) || null,
        },
        summary: {
            totalEarnings: ((_a = totalEarnings[0]) === null || _a === void 0 ? void 0 : _a.total) || 0,
            earningsThisMonth: ((_b = thisMonthEarnings[0]) === null || _b === void 0 ? void 0 : _b.total) || 0,
            totalBookings,
            totalVehicles,
            activeVehicles,
        },
...
const getPayouts = (hostId, payoutStatus) => __awaiter(void 0, void 0, void 0, function* () {
