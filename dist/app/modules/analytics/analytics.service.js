...
const getGuestHostYearlyChart = (year) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const chart = Array.from({ length: 12 }).map((_, i) => {
      ...
      return {
        ...
        guest:
          ((_b =
            (_a = row === null || row === void 0 ? void 0 : row.data) ===
              null || _a === void 0
              ? void 0
              : _a.find((d) => d.role === user_1.USER_ROLES.USER)) === null ||
          _b === void 0
            ? void 0
            : _b.total) || 0,
        host:
          ((_d =
            (_c = row === null || row === void 0 ? void 0 : row.data) ===
              null || _c === void 0
              ? void 0
              : _c.find((d) => d.role === user_1.USER_ROLES.HOST)) === null ||
          _d === void 0
            ? void 0
            : _d.total) || 0,
      };
