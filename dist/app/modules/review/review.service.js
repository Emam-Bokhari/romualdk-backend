...
const createReviewToDB = (payload, reviewerId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const reviewData = {
      ...
      feedback:
        (_a = payload.feedback) === null || _a === void 0 ? void 0 : _a.trim(),
    };
...
const getReviewSummaryFromDB = (targetId, type) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const objectId = new mongoose_1.Types.ObjectId(targetId);
    if (!targetId || !type) {
      throw new ApiErrors_1.default(
        400,
        "targetId and type (CAR/HOST) are required",
      );
    }
    if (
      type !== review_interface_1.REVIEW_TYPE.CAR &&
      type !== review_interface_1.REVIEW_TYPE.HOST
    ) {
    ...
    const reviewList = reviews.map((review) => {
      ...
      return {
        ...
        fromUser: {
          ...
          email:
            (_a = review.fromUserId) === null || _a === void 0
              ? void 0
              : _a.email,
          phone:
            (_b = review.fromUserId) === null || _b === void 0
              ? void 0
              : _b.phone,
          profileImage:
            (_c = review.fromUserId) === null || _c === void 0
              ? void 0
              : _c.profileImage,
          location:
            (_d = review.fromUserId) === null || _d === void 0
              ? void 0
              : _d.location,
        },
      };
