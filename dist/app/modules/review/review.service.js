...
const createReviewToDB = (payload, reviewerId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!Number.isInteger(payload.ratingValue) ||
    ...
    const reviewList = reviews.map((review) => {
        ...
        return ({
            ...
            fromUser: {
                ...
                email: (_a = review.fromUserId) === null || _a === void 0 ? void 0 : _a.email,
                phone: (_b = review.fromUserId) === null || _b === void 0 ? void 0 : _b.phone,
                profileImage: (_c = review.fromUserId) === null || _c === void 0 ? void 0 : _c.profileImage,
                location: (_d = review.fromUserId) === null || _d === void 0 ? void 0 : _d.location,
            },
        });
    });
    return {
