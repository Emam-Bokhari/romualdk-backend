...
const checkFavouriteCarStatus = (userId, referenceId) =>
...
const toggleFavourite = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const existing = yield favouriteCar_model_1.FavouriteCar.findOne({
      userId,
      referenceId,
    });
    if (existing) {
    ...
    const result = favourites.map((favourite) => {
      ...
      return {
        ...
        car: {
          ...
          pricePerDay:
            car === null || car === void 0 ? void 0 : car.pricePerDay,
...
const getSingleFavourite = (userId, favouriteId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const favourite = yield favouriteCar_model_1.FavouriteCar.findOne({
      _id: favouriteId,
      userId,
...
const deleteFavourite = (userId, referenceId) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield favouriteCar_model_1.FavouriteCar.deleteOne({
      userId,
      referenceId,
    });
