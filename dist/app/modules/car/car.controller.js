...
const createCar = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield car_service_1.CarServices.createCarToDB(
      userId,
      carData,
    );
...
const getRecentCars = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
...
const getOwnCars = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { verificationStatus } = req.query;
    const result = yield car_service_1.CarServices.getOwnCarsFromDB({
      userId: req.user.id,
      verificationStatus: (0, car_utils_1.normalizeCarVerificationStatus)(
        verificationStatus,
      ),
    });
    (0, sendResponse_1.default)(res, {
...
const getAllCarsForVerifications = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result =
      yield car_service_1.CarServices.getAllCarsForVerificationsFromDB(
        req.query,
      );
    (0, sendResponse_1.default)(res, {
      success: true,
...
const deleteCarById = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const { id: userId } = req.user;
    const result = yield car_service_1.CarServices.deleteCarByIdFromDB(
      userId,
      id,
    );
    (0, sendResponse_1.default)(res, {
...
const createCarBlockedDates = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { carId } = req.params;
    const { id: userId } = req.user;
    const { blockedDates } = req.body;
    const result = yield car_service_1.CarServices.createCarBlockedDatesToDB(
      carId,
      userId,
      blockedDates,
    );
...
const updateCarVerificationStatusById = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { verificationStatus } = req.body;
    const { carId } = req.params;
    const result =
      yield car_service_1.CarServices.updateCarVerificationStatusByIdToDB(
        carId,
        verificationStatus,
      );
    (0, sendResponse_1.default)(res, {
...
const getSuggestedCars = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id: userId } = req.user;
    const limit = parseInt(req.query.limit) || 10;
    const cars = yield car_service_1.CarServices.getSuggestedCarsFromDB(
      userId,
      limit,
    );
    (0, sendResponse_1.default)(res, {
...
const getCarsByDestination = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield car_service_1.CarServices.getCarsByDestinationFromDB(destinationId);
    (0, sendResponse_1.default)(res, {
      statusCode: 200,
      success: true,
