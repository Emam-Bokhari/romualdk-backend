...
exports.getTargetLocation = exports.normalizeCarVerificationStatus = exports.getCarCalendar = exports.checkCarAvailabilityByDate = exports.getCarTripCountMap = exports.getCarTripCount = void 0;
...
const normalizeCarVerificationStatus = (status) => {
    ...
    if (!Object.values(car_interface_1.CAR_VERIFICATION_STATUS).includes(normalized)) {
        throw new ApiErrors_1.default(400, `Invalid car verification status: ${status}`);
    }
    return normalized;
};
