...
router
    ...
    .get((0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.HOST, user_1.USER_ROLES.USER), car_controller_1.CarControllers.getAllCars);
router.get("/recent", (0, optionalAuth_1.default)(), car_controller_1.CarControllers.getRecentCars);
router.get("/my", (0, auth_1.default)(user_1.USER_ROLES.HOST), car_controller_1.CarControllers.getOwnCars);
router.get("/suggested", (0, auth_1.default)(user_1.USER_ROLES.USER, user_1.USER_ROLES.HOST), car_controller_1.CarControllers.getSuggestedCars);
router.get("/by-destination/:destinationId", car_controller_1.CarControllers.getCarsByDestination);
...
router.get("/verification", (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN), car_controller_1.CarControllers.getAllCarsForVerifications);
router.patch("/verification/status/:carId", (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN), car_controller_1.CarControllers.updateCarVerificationStatusById);
router
    .route("/:id")
