...
const optionalAuth_1 = __importDefault(
...
router.get(
  "/recent",
  (0, optionalAuth_1.default)(),
  car_controller_1.CarControllers.getRecentCars,
);
router.get(
  "/my",
  (0, auth_1.default)(user_1.USER_ROLES.HOST),
  car_controller_1.CarControllers.getOwnCars,
);
router.get(
  "/suggested",
  (0, auth_1.default)(user_1.USER_ROLES.USER, user_1.USER_ROLES.HOST),
  car_controller_1.CarControllers.getSuggestedCars,
);
router.get(
  "/by-destination/:destinationId",
  car_controller_1.CarControllers.getCarsByDestination,
);
router.get(
  "/availability/:carId",
...
router.patch(
  "/blocked/:carId",
  (0, auth_1.default)(user_1.USER_ROLES.HOST),
  car_controller_1.CarControllers.createCarBlockedDates,
);
router.get(
  "/verification",
  (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN),
  car_controller_1.CarControllers.getAllCarsForVerifications,
);
router.patch(
  "/verification/status/:carId",
  (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN),
  car_controller_1.CarControllers.updateCarVerificationStatusById,
);
router
  .route("/:id")
  .get(
    ...
    car_controller_1.CarControllers.getCarById,
  )
  .patch(
    (0, auth_1.default)(user_1.USER_ROLES.HOST),
    (0, fileUploaderHandler_1.default)(),
