...
exports.smsCallback = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d, _e;
    // Logging for debugging
    console.log("SMS Callback Hit:", req.method, { query: req.query, body: req.body });
    // Handle both GET and POST parameters
    const resourceId = ((_a = req.query.resourceId) === null || _a === void 0 ? void 0 : _a.toString()) || ((_b = req.query.resource_id) === null || _b === void 0 ? void 0 : _b.toString()) || req.body.resourceId || req.body.resource_id;
    const code = ((_c = req.query.code) === null || _c === void 0 ? void 0 : _c.toString()) || ((_d = req.query.status_code) === null || _d === void 0 ? void 0 : _d.toString()) || req.body.code || req.body.status_code;
    const message = ((_e = req.query.message) === null || _e === void 0 ? void 0 : _e.toString()) || req.body.message;
    if (!resourceId || !code) {
