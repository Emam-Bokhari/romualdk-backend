...
/* ---------------------------- HOST LIST & DETAILS ----------------------- */
router.get("/host", requireAdminOrSuperAdmin, user_controller_1.UserController.getAllHosts);
router.get("/host/:id", requireAdminOrSuperAdmin, user_controller_1.UserController.getHostById);
router.get("/host-details/:id", requireAnyUser, user_controller_1.UserController.getHostDetailsById);
/* ---------------------------- ADMINS LIST ------------------------------- */
...
/* ---------------------------- STATUS UPDATE ----------------------------- */
router.patch("/host/status/:id", requireAdminOrSuperAdmin, user_controller_1.UserController.updateHostStatusById);
