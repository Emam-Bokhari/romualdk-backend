...
// register admin
const createAdmin = (0, catchAsync_1.default)((req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const userData = __rest(req.body, []);
...
const createHostRequest = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id: userId } = req.user;
    const data = req.body;
    const result = yield user_service_1.UserService.createHostRequestToDB(
      userId,
      data,
    );
    (0, sendResponse_1.default)(res, {
...
const getAllHostRequests = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield user_service_1.UserService.getAllHostRequestsFromDB(
      req.query,
    );
    (0, sendResponse_1.default)(res, {
      success: true,
...
const getHostRequestById = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result =
      yield user_service_1.UserService.getHostRequestByIdFromDB(id);
    (0, sendResponse_1.default)(res, {
      success: true,
      statusCode: 200,
...
const changeHostRequestStatusById = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const { hostStatus } = req.body;
    const result =
      yield user_service_1.UserService.changeHostRequestStatusByIdFromDB(
        id,
        hostStatus,
      );
    (0, sendResponse_1.default)(res, {
...
const deleteHostRequestById = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const result =
      yield user_service_1.UserService.deleteHostRequestByIdFromDB(id);
    (0, sendResponse_1.default)(res, {
      success: true,
      statusCode: 200,
...
const getAllHosts = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield user_service_1.UserService.getAllHostsFromDB(
      req.query,
    );
    (0, sendResponse_1.default)(res, {
      success: true,
...
const getHostDetailsById = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const { id: visitorId } = req.user;
    const result = yield user_service_1.UserService.getHostDetailsByIdFromDB(
      id,
      visitorId,
    );
    (0, sendResponse_1.default)(res, {
