...
const getHostDetailsById = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const { id: visitorId } = req.user;
    const result = yield user_service_1.UserService.getHostDetailsByIdFromDB(id, visitorId);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: 200,
