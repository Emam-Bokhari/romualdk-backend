...
const createUserToDB = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        // Send SMS + save log
        const smsLog = yield afrikSms_service_1.afrikSmsService.sendSMS(createUser.phone, createUser.countryCode, smsMessage, createUser._id.toString());
    ...
    const createToken = jwtHelper_1.jwtHelper.createToken({ id: createUser._id, phone: createUser.phone, role: createUser.role }, config_1.default.jwt.jwt_secret, config_1.default.jwt.jwt_expire_in);
    return {
        token: createToken,
        user: createUser,
    };
...
const createHostRequestToDB = (userId, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!payload.drivingLicenseFrontPic || !payload.drivingLicenseBackPic) {
        throw new ApiErrors_1.default(400, "Driving license front and back picture is required");
    }
...
const getAllHostRequestsFromDB = (query) => __awaiter(void 0, void 0, void 0, function* () {
    const baseQuery = user_model_1.User.find({
        hostStatus: {
            $in: [user_1.HOST_STATUS.PENDING, user_1.HOST_STATUS.APPROVED, user_1.HOST_STATUS.REJECTED],
        },
    });
    const queryBuilder = new queryBuilder_1.default(baseQuery, query)
...
const getHostRequestByIdFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!result)
        throw new ApiErrors_1.default(404, "No host request is found in the database by this ID");
    return result;
});
...
const getAllHostsFromDB = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { searchTerm, sortBy = "createdAt", sortOrder = "desc" } = query, filters = __rest(query, ["searchTerm", "sortBy", "sortOrder"]);
    /* -------------------- MATCH (BASE FILTER) -------------------- */
    const matchStage = {
...
const getHostDetailsByIdFromDB = (id, visitorId) => __awaiter(void 0, void 0, void 0, function* () {
    if (!mongoose_1.Types.ObjectId.isValid(id)) {
        throw new ApiErrors_1.default(400, "Invalid host ID");
    }
    // 1. Get the visitor's location (same logic as getAllCars)
    const { lat, lng } = yield (0, car_utils_1.getTargetLocation)(undefined, undefined, visitorId);
    const pipeline = [
