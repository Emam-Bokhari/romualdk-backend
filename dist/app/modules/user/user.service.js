...
const createUserToDB = (payload) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield sendOtpWithVerify_1.twilioService.sendOTPWithVerify(
      createUser.phone,
...
const switchProfileToDB = (userId, role) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (![user_1.USER_ROLES.USER, user_1.USER_ROLES.HOST].includes(role))
      throw new ApiErrors_1.default(
        400,
        "Role is mustbe either 'USER' or 'HOST'",
      );
    if (
      role === user_1.USER_ROLES.HOST &&
      user.hostStatus !== user_1.HOST_STATUS.APPROVED
    ) {
      throw new ApiErrors_1.default(
        400,
        "User cannot switch to host before admin approval",
      );
    }
    ...
    if (!result) throw new ApiErrors_1.default(400, "Failed to update role");
    return result;
  });
